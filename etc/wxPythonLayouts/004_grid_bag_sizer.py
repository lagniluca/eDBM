...
class GridBagSizerExample(wx.Frame):

    def __init__(self, parent):
        super(GridBagSizerExample, self).__init__(parent, title='GridBagSizer example')
    ...
    def _InitUI(self):
        ...
        buttonI = wx.Button(panel, label='button 1')
        sizer.Add(buttonI, pos=(0,4), flag=wx.TOP|wx.RIGHT|wx.ALIGN_RIGHT, border=5)

        line = wx.StaticLine(panel)
        sizer.Add(line, pos=(1, 0), span=(1,5), # Comando per allargare un componente su più colonne
